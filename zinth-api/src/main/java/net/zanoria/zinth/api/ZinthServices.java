...
public final class ZinthServices {
    ...
    public static void init(SnapshotService snapshots, CombatService combat, PerfService perf, EvidenceService evidence, IPacketBus packetBus, ShadowService shadow) {
